    ...
    <div class="card" style="width: 50rem">
        ...
        <form action="{{route('events.store')}}" method="POST">
            ...
            <div class="input-group mb-3">
                ...
                <input type="text" class="form-control" placeholder="Location" aria-label="Location" aria-describedby="basic-addon1" name="location_id">
            ...
            <div class="d-flex flex-row justify-content-center">
                ...
                {{-- <a href="/"><input type="submit" class="btn btn-primary me-2" value="Guardar"></a>
                <a href="/"><input type="reset" class="btn btn-danger ms-2" value="Cancelar"></a>
                <a href="javascript:history.back()" > <input type="submit" class="btn btn-success ms-2" value="Volver"></a> --}}
            </div>
        </form>
        </div>
